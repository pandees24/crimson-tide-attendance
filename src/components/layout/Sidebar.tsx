...
export function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  if (isMobile) {
    return (
      <>
        ...
        <aside 
          className={cn(
            "fixed left-0 top-0 z-50 h-screen w-64 bg-sidebar text-sidebar-foreground transition-transform duration-300 flex flex-col lg:hidden",
        ...
        >
          ...
          <Button
            ...
            size="icon"
            onClick={onClose}
            className="absolute right-2 top-3 text-sidebar-foreground hover:bg-sidebar-accent/50"
          >
            <X className="w-5 h-5" />
          </Button>
  ...
  return (
    <aside 
      className={cn(
        "fixed left-0 top-0 z-40 h-screen bg-sidebar text-sidebar-foreground transition-all duration-300 flex flex-col hidden lg:flex",
